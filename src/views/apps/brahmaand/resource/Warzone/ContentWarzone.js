          ...
          <CardBody>
            <Form className="m-1">
              <Row>
                ...
                <Col lg="4" md="4" sm="4" className="mb-2">
                  <FormGroup>
                    <Label>Content Creator list</Label>
                    <CustomInput
                      type="select"
                      name="sub_category"
                      value={sub_categoryp}
                ...
                <Col lg="4" md="4" sm="4" className="mb-2">
                  <FormGroup>
                    <Label>Second Content Creator list</Label>
                    <CustomInput
                      type="select"
                      name="sub_category"
                      value={sub_categorys}
