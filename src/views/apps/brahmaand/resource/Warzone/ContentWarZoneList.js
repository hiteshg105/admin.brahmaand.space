...
class ContentWarZoneList extends React.Component {
  state = {
    rowData: [],
    aprv_status: "",
  ...
  async runthisfunction(id) {
    // console.log(id);
    await axiosConfig.delete(`/delete/creator_warzone/${id}`).then(
      (response) => {
...
export default ContentWarZoneList;
